...
public class VehicleRoutingPanel extends SolutionPanel {
    ...
    public void insertLocationAndCustomer(double longitude, double latitude) {
        ...
        nextLocationId++;
        newLocation.setY(longitude);
        newLocation.setX(latitude);
        ...
        solutionBusiness.doProblemFactChange(new ProblemFactChange() {
            public void doChange(ScoreDirector scoreDirector) {
                ...
                if (schedule instanceof TimeWindowedVehicleRoutingSolution) {
                    ...
                    TimeWindowedDepot timeWindowedDepot = (TimeWindowedDepot) schedule.getInitialLocationList().get(0);
                ...
                schedule.getTaskList().add(newCustomer);
