...
public class problem
{
	...
	private static void createState0(State s)	{
		...
		s.add(new Predicate(10, 0, new TermList(TermConstant.getConstant(24), new TermList(TermConstant.getConstant(20), TermList.NIL))));
		s.add(new Predicate(10, 0, new TermList(TermConstant.getConstant(30), new TermList(TermConstant.getConstant(20), TermList.NIL))));
		s.add(new Predicate(10, 0, new TermList(TermConstant.getConstant(32), new TermList(TermConstant.getConstant(20), TermList.NIL))));
		s.add(new Predicate(10, 0, new TermList(TermConstant.getConstant(25), new TermList(TermConstant.getConstant(21), TermList.NIL))));
		s.add(new Predicate(10, 0, new TermList(TermConstant.getConstant(26), new TermList(TermConstant.getConstant(21), TermList.NIL))));
		s.add(new Predicate(10, 0, new TermList(TermConstant.getConstant(27), new TermList(TermConstant.getConstant(21), TermList.NIL))));
		s.add(new Predicate(10, 0, new TermList(TermConstant.getConstant(33), new TermList(TermConstant.getConstant(21), TermList.NIL))));
		s.add(new Predicate(10, 0, new TermList(TermConstant.getConstant(24), new TermList(TermConstant.getConstant(22), TermList.NIL))));
		s.add(new Predicate(10, 0, new TermList(TermConstant.getConstant(29), new TermList(TermConstant.getConstant(22), TermList.NIL))));
		s.add(new Predicate(10, 0, new TermList(TermConstant.getConstant(31), new TermList(TermConstant.getConstant(22), TermList.NIL))));
		s.add(new Predicate(10, 0, new TermList(TermConstant.getConstant(34), new TermList(TermConstant.getConstant(22), TermList.NIL))));
		s.add(new Predicate(10, 0, new TermList(TermConstant.getConstant(25), new TermList(TermConstant.getConstant(23), TermList.NIL))));
		s.add(new Predicate(10, 0, new TermList(TermConstant.getConstant(26), new TermList(TermConstant.getConstant(23), TermList.NIL))));
		s.add(new Predicate(10, 0, new TermList(TermConstant.getConstant(28), new TermList(TermConstant.getConstant(23), TermList.NIL))));
