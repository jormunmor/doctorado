...
//-----------------------------------------------------------------------------
	...
	/*
		The following code was added to hide the GUI and use JSHOP2 as
		a command line process. By default we have this disabled to 
		see that a plan is found and to debug it with the graphical 
		tools. To enable this, comment the setVisible line and uncomment
		the rest.
	*/
...
//-----------------------------------------------------------------------------  
	...
	while(enumNodes.hasMoreElements()) {
        ...
        new PlanDialog( title, plan );
					...
					System.out.println("Unsupported encoding. Unable to create text file for the plan.");
