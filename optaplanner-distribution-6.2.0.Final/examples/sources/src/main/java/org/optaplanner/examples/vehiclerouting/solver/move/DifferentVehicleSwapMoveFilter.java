 ...
 * @author jorge
 */
public class DifferentVehicleSwapMoveFilter implements SelectionFilter<SwapMove> {

    @Override
    public boolean accept(ScoreDirector sd, SwapMove move) {
        Task leftTask = (Task) move.getLeftEntity();
        Task rightTask = (Task) move.getRightEntity();
        
        return !leftTask.getVehicle().equals(rightTask.getVehicle());
