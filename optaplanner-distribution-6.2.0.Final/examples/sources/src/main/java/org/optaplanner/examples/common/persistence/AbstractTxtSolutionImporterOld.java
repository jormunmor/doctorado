...
public abstract class AbstractTxtSolutionImporterOld extends AbstractSolutionImporter {

    private static final String DEFAULT_INPUT_FILE_SUFFIX = "txt";

    protected AbstractTxtSolutionImporterOld(SolutionDao solutionDao) {
        super(solutionDao);
    }

    protected AbstractTxtSolutionImporterOld(boolean withoutDao) {
        super(withoutDao);
    }
